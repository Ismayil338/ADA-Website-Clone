...
PROGRAMS_URL = "https://www.ada.edu.az/en/admission/find-your-program"
OUTPUT_PATH = Path("data") / "programs_items.json"
...
def parse_programs_items(html: str) -> List[Dict[str, Optional[str]]]:
    ...
    for card in soup.select("div.filtered-item"):
        ...
        level_div = card.select_one("div.level")
...
def main() -> None:
    html = fetch_html(PROGRAMS_URL)
    data = parse_programs_items(html)
